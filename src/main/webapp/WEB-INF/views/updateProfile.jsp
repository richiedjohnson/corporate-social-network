...
<div style="margin-top: 30px; height:420px; width: 350px; background-color: #DEDEDE; padding-top:20px;">
	<form action="/csn/user-profile-edit" method="post">
	<font color="red" style="font-size: small">${requestScope.message}</font>
	<table cellpadding="5">
	 <tr><td>Employee Id</td><td><c:out value="${sessionScope.emp}" /></td></tr>
	 ...
	 <tr><td colspan="2" align="right"><button type="submit">Update</button></td></tr>
	</table>
	</form>
</div>